    ...
    <div className="min-h-screen bg-linear-to-br from-blue-100 via-purple-100 to-pink-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="bg-white/90 dark:bg-gray-900/90 rounded-2xl shadow-xl p-8 border border-purple-200 dark:border-gray-700">
          <h1 className="text-3xl font-bold text-purple-700 dark:text-purple-300 mb-8">Crear Nuevo Caso</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex gap-3 pt-4">
              <button
                type="submit"
                className="flex-1 bg-linear-to-r from-green-500 to-emerald-500 text-white font-bold p-3 rounded-lg shadow hover:from-green-600 hover:to-emerald-600 transition-colors flex items-center justify-center disabled:opacity-60"
                disabled={loading}
              >
                {loading ? <Spinner className="h-6 w-6" /> : "✓ Crear Caso"}
              </button>
              <button
                type="button"
                onClick={() => router.push("/casos")}
